...
\begin{figure}\label{fig:dactor_diagram}
  \centering
  \includestandalone[width=0.9\textwidth]{pictures/tikz/dactor_diagram}
  \caption{Class diagram of the \code{Film} and \code{Actor} Dactor types defined in the example application.}
\end{figure}

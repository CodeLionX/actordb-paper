...
The partial denormalization of information, which relates directly to \code{Actor} instances, into the \code{Film.Cast} \gls{relation} of \code{Film} type \glspl{dactor},
...
Figure \ref{fig:functor_diagram} displays the message-flow between the involved Dactors and Functors, as well as their supervision \glspl{relation}.

...
\section{Related Work}
  ...
  Despite this popularity \citeauthor{manifesto}~\cite{manifesto} state that actor programming models still expose state management to the application.
  ...
  \citeauthor{manifesto} see a need of state management guarantees in actor systems and propose to integrate actor-based programming models in database management systems.

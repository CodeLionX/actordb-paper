...
\section{Related Work}\label{sec:related_work}
  ...
  It has gained popularity and has been implemented anew as language extensions or frameworks for existing object-oriented and functional languages, such as C\#, Java, and Scala, in the mid-2000's.
  In this section, we give an outline of the recent history of actor model implementations,
  ...
  A developer does not need to know, where a specific actor is physically located to send messages to it.
  ...
  In their prototype actorDB, an actor encapsulates a full relational SQL database using the SQLite database engine\footnote{\url{https://www.sqlite.org/about.html}}.

...
\subsection{Experimental Setup}
  ...
  The exemplary actor database system used for testing consists of four different \gls{dactor} types, each containing a different number of relations and data sizes.
...
\subsection{Discussion}\label{sec:exp:discussion}
  ...
  \Glspl{dactor} have a constant overhead of about 533~B per instance.

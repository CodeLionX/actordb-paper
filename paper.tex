...
\begin{abstract}
  ...
  More specifically, we propose the concept of \emph{domain actors} that provide a typesafe, SQL-like interface to develop the actors of our database system and the concept of \emph{functors} to build queries retrieving data contained in multiple actor instances.
